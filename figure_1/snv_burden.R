################################################################################
# Fig 1 | Somatic SNV burden versus age across cell types
################################################################################
...
ggsave(file.path(output_path, "fig1d_snv_burden_comparison.pdf"), plot = p,
       width = 6.7, height = 5)
